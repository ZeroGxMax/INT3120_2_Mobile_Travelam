            ...
            <View className="items-center absolute flex-row inset-x-0 bottom-0 justify-center px-4 bg-white/70 pt-3 pb-5">
                <View className="">
                    {data?.price ?
                        <View className="flex-column items-center justify-center pr-6">
                            <Text>
                                <Text className="font-bold text-xl text-[#336699]">¥</Text>
                ...
                <TouchableOpacity
                    ...
                    <View className="w-full h-16 rounded-full">
                        ...
                        >
                            <Text className="text-white text-xl bg-gradient-to-tr from-[#5CA7F1] from-10% to-[#336699] to-90%">Book Now</Text>
                        </LinearGradient>
                    </View>
                </TouchableOpacity>
            </View>
