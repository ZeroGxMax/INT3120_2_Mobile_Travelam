...
import { getCountryIdFromAccommodationId, getCountryFromId } from '../../../services/firebase/country';
...
const AccomDetailScreen = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const fetchedCountryId = await getCountryIdFromAccommodationId(item.id);
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.descriptionWrapper}>
                ...
                <PriceSection content={item.pricePerNight} />
            </View>
        </ScrollView>
    );
};
...
export default AccomDetailScreen;
